...
if($action == 'save_promotion'){
	$save = $crud->save_promotion();
	if($save)
		echo $save;
}
if($action == 'delete_promotion'){
	$save = $crud->delete_promotion();
	if($save)
		echo $save;
}
...
if($action == 'save_award'){
	$save = $crud->save_award();
	if($save)
		echo $save;
}
if($action == 'delete_award'){
	$save = $crud->delete_award();
	if($save)
		echo $save;
}
...
if($action == 'save_evalacc'){
	$save = $crud->save_evalacc();
	if($save)
		echo $save;
}
...
if($action == 'save_erestriction'){
	$save = $crud->save_erestriction();
	if($save)
		echo $save;
}
