...
<div class="container-fluid">
	<form action="" id="manage-class">
		...
		<div class="form-group">
			<label for="curriculum" class="control-label">Student Level</label>
		...
		$('#manage-class').submit(function(e){
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						alert_toast("Student Level successfully saved.","success");
						setTimeout(function(){
							location.reload()	
						},1750)
					}else if(resp == 2){
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Student Level already exist.</div>')
						end_load()
					}
				}
			})
