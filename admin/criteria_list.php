...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><strong> Manage Questionnaire's Criteria </strong></h1>
          </div><!-- /.col -->
						...
						<div class="card card-outline card-danger">
							...
							<div class="card-footer">
								<div class="d-flex justify-content-end w-100">
									<button class="btn btn-sm btn-danger btn-flat bg-gradient-danger mx-1" form="manage-criteria">Save</button>
						...
						<div class="callout callout-danger">
							...
							<div class="d-flex justify-content-between w-100">
								<label for=""><b>Criteria List</b></label>
									<button class="btn btn-sm btn-danger btn-flat bg-danger mx-1" form="order-criteria">Save Order</button>
							</div>
							<hr>
								...
								<li class="list-group-item text-left">
									<span class="btn-group dropright float-right">
									  ...
									  <div class="dropdown-menu">
									     <a class="dropdown-item edit_criteria" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" id="wd">Edit</a>
